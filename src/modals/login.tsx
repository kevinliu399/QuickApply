...
const LoginModal: React.FC<LoginModalProps> = ({ onClick, password, username, email, isOpen, onSignUpClick }) => {
    ...
    return (
        <div className="fixed inset-0 flex items-center pl-54 justify-center bg-black bg-opacity-50">
            <div className="bg-white p-6 rounded-lg shadow-lg w-1/2">
                <div className="flex justify-between items-center">
                    <h1 className="text-2xl font-bold mb-4">Register</h1>
                    <CircleX size={20} onClick={onClick}/>
                </div>
                ...
                <p className="mt-4">Already have an account? <a className="text-blue-800 cursor-pointer" onClick={onSignUpClick}>Sign In</a></p>    
            </div>
